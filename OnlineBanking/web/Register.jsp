                ...
                <div class="header_resize">
                    ...
                    <div class="menu_nav">
                        <ul>
                            ...
                            <li><a href="Register.jsp#con"><span>About Us</span></a></li>
                            <li><a href="Register.jsp#con"><span>Contact Us</span></a></li>
                        </ul>
                    </div>
                    <div class="clr"></div>
                    <div class="slider">
                        ...
                        <div class="header">
                            <div class="header_resize">
                                ...
                                <div class="menu_nav" style="margin-right:700px ;" >
                                    <ul>
                                        <li ><a href="LogIn.jsp"><span>Sign In</span></a></li>
                                        <li class="active1"><a href="#"><span>Sign UP</span></a></li>
                        ...
                        <section class="main">
                            ...
                            <form class="form-4" method="post" action="LogIn">
                                ...
                                <p>
                                    ...
                                    <input type="text" name="employeeEmail" placeholder="Username or email" required >
                                </p>

                                <p>
                                    <label for="password">Password</label>
                                    <input type="password" name='employeePass' placeholder="Password" required> 
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <input type="number" name="employeePhone" placeholder="Phone" required >
                                </p>
                                <p>
                                    <label for="login">Address </label>
                                    <input type="text" name="employeeAddress" placeholder="Address" required />
                                </p>
                                <p>
